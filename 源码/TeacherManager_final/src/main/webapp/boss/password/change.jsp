					  ...
					  <br/>
                       ...
                       <form class="forms-sample" action="#">
                         <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="exampleInputName1" placeholder="请输入新密码">
                         </div>
                         <div class="form-group">
                           <label for="exampleInputEmail3">请再次确认新密码</label>
                           <input type="text" class="form-control" id="exampleInputEmail3" placeholder="请再次确认新密码">
                         </div>
						 <!--确定修改，修改完成后跳到success_change.html -->
						 <a href="<%=basePath%>leader/change_suc.jsp"><button class="btn btn-gradient-primary mr-2">确定</button></a>

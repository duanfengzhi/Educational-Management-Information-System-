			...
			查看、导入实验排课信息
		        ...
		        <button class="btn btn-outline-primary" onclick="changeImg18()" >2018</button> 
		          ...
		          <div class="row" style="margin-top:3%">
		            <div>
		              <img id="experimentSchedule" src="<%=basePath%>images/2016experiment.jpg" style="height: 625px" >
		            </div>
		          </div>
	              ...
	              <div class="card">
	                <div class="card-body">
	                  ...
	                  <form class="forms-sample" action="<%=basePath %>uploadPreImg" method="post" enctype="multipart/form-data" onsubmit="return check();">
...
<script type="text/javascript">
	function changeImg15() {
	    var obj = document.getElementById("experimentSchedule");   
	    obj.setAttribute("src", "<%=basePath%>images/2015experiment.jpg" );
	}
	function changeImg16() {
	    var obj = document.getElementById("experimentSchedule");   
	    obj.setAttribute("src", "<%=basePath%>images/2016experiment.jpg" );
	}
	function changeImg17() {
	    var obj = document.getElementById("experimentSchedule");   
	    obj.setAttribute("src", "<%=basePath%>images/2017experiment.jpg" );
	}
	function changeImg18() {
	    var obj = document.getElementById("experimentSchedule");   
	    obj.setAttribute("src", "<%=basePath%>images/2018experiment.jpg" );
	}
</script>
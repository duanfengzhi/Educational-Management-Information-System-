	...
	<div class="page-header">
		<h3 class="page-title">
			...
			<div class="col-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">导入管理员账号</h4>
                  <p class="card-description">
                    	请选择Excel格式文件
                  </p>
                  <form class="forms-sample" action="<%=basePath %>admin/ImportMngInfoCtrl" method="post" enctype="multipart/form-data" onsubmit="return check();">
			...
			<div class="col-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">导入领导信息</h4>
                  <p class="card-description">
                    请选择Excel格式文件
                  </p>
                  <form class="forms-sample" action="<%=basePath %>admin/ImportBossInfoCtrl" method="post" enctype="multipart/form-data" onsubmit="return check();">
                    <div class="form-group">
                      <label>文件名</label>
                      <input type="file" id="excel_file" name="filename" class="file-upload-default" accept="xlsx" size="80">
                      <div class="input-group col-xs-12">
                    ...
                    <button type="submit" id="excel_button" class="btn btn-gradient-primary mr-2">导入Excel</button>
                    <font id="importMsg" color="red">${msg2 }</font><input type="hidden" />
                  </form>
                </div>
              </div>
            </div>

					   ...
					   <div class="row">
						<div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="engBack" value="${sessionScope.teacher.engBack }">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">主持项目</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="project" value="${sessionScope.teacher.project }">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">论文</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="paper" value="${sessionScope.teacher.paper }">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">专利</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="patent" value="${sessionScope.teacher.patent }">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">软著</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="theSoft" value="${sessionScope.teacher.theSoft }">
                            </div>
                          </div>
						  <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">专著</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="mono" value="${sessionScope.teacher.mono }">
                            </div>
                          </div>
						  <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">教研论文</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="teaPaper" value="${sessionScope.teacher.teaPaper }">
                            </div>
                          </div>
						</div> 
						<div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="teahonor" value="${sessionScope.teacher.teahonor }">
                            </div>
                          </div>
						  <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">师德师风表彰</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="teaMorality" value="${sessionScope.teacher.teaMorality }">
                            </div>
                          </div>
						  <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label">与本学院科研结果</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="" name="coorResult" value="${sessionScope.teacher.coorResult }">
                            </div>
                          </div>

...
<html>
 ...
 <div class="content-wrapper">
   ...
   <c:forEach var="c" items="${requestScope.classTable}">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">${c.cname }</h4>
                  <div class="template-demo">
                    <h4><code>课程编号</code> : ${c.cno } </h4>
                    <h4><code>上课周</code> : ${c.ctimeweek }</h4>
                    <h4><code>星期</code> : ${c.ctimeday }</h4>
                    <h4><code>时间</code> : ${c.ctime }</h4>
                    <h4><code>教室</code> : ${c.caddr }</h4>
                    <h4><code>教师姓名</code> : ${c.exteaname }</h4>
                  </div>
                </div>
              </div>
            </div>

                ...
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
					  ...
					  <br/>
					  <!-- 这里有一个表单连接后台操作 -->
					  <a href="<%=basePath%>teacher/feedback/list.jsp"><button class="btn btn-gradient-primary mr-2">已读</button>
                      <a href="<%=basePath%>teacher/allFeedBackCtrl"><button class="btn btn-gradient-primary mr-2">返回</button></a>
				   </div>
                  </div>
                </div>
			  </div>
				  ...
				  <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="<%=basePath %>exteacher/replyCtrl?fnum=${f.fnum }" method="POST">
                          <div class="form-group">
                            <label for="exampleTextarea1">回复内容</label>
                            <textarea class="form-control" name="reply" id="exampleTextarea1" rows="8" placeholder="字数不得超出500字......"><c:if test="${ not empty f.reply }">${f.reply}</c:if><c:if test="${empty f.reply}">请填写回复</c:if></textarea>
                          </div>
						  <!-- <div class="form-group">
                            <label>添加图片</label>
                           ...
                           <a href="<%=basePath%>teacher/feedback/list.jsp"><button type="button" class="btn btn-light">取消</button></a>
                        </form>
					  </div>
					</div>
				  </div>

           ...
           <div class="content-wrapper">   
		     <div class="page-header">
               ...
               <nav aria-label="breadcrumb">
    			...
    			<%-- <form action="exteacher/allFeedBackCtrl" method="POST">
    			...
    			<form action="exteacher/allFeedBackCtrl" method="POST" class="forms-sample">
        			<table width="800">
        			  <tr align="center">
	        			    <td>
                            ...
                            <tbody align="center">
                             ...
                             <c:forEach var="f" items="${requestScope.feedbacks}">
	                               <tr>
		                              ...
		                              <td>
		                               <a href="<%=basePath%>exteacher/detailFeedBackDetailCtrl?fnum=${f.fnum}"><button type="button" class="btn btn-outline-primary btn-rounded btn-sm btn-fw">查看详情</button></a>
									  </td>
	                               </tr>
                             </c:forEach>
						 ...
						 <nav aria-label="breadcrumb">
                           <ul class="breadcrumb">
						   <a href="<%=basePath%>exteacher/allFeedBackCtrl?page=0">首 页</a>&nbsp;&nbsp;&nbsp;&nbsp; </a>
						   <a href="<%=basePath%>exteacher/allFeedBackCtrl?page=prev">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						   <a href="<%=basePath%>exteacher/allFeedBackCtrl?page=next">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						   <a href="<%=basePath%>exteacher/allFeedBackCtrl?page=${requestScope.lastPage}">末 页</a>
						   </ul>
                         </nav>
                       </div>
                    </div>
